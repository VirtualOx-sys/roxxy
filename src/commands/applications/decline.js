...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      usage: "<usuario> <app ID> <razón>",
      category: "Aplicaciones",
      examples: ["decline @VirtualOx Razón Aqui"],
      description: "Rechazar una solicitud en el servidor.",
      cooldown: 5,
        ...
        .send({
          embeds: [
            new discord.MessageEmbed()
              ...
              .setTitle(language.declinedeclined)
              .setDescription(
                `${client.emoji.fail} Oye ${member.user.tag}, ${language.declinedeclineddescriptionmember} ${id}\n**Rechazado por:** ${message.author.tag}\n**Razón:** ${reason}`
              ),
          ],
        })
        .catch(() => {
          message.channel.sendCustom(
            `No importa... Pude rechazar la solicitud, pero no pude enviar mensaje directo a ${member.user.tag} porque sus mensajes directos están cerrados.'`
          );
        });
    }
  }
