  ...
  async run(message, args) {
    ...
    if (talkedRecently.has(message.author.id)) {
      message.channel.sendCustom(
        `Estás **bloqueado** del siguiente comando - ${message.author}`
      );
    } else {
      ...
      message.channel.sendCustom({
        embeds: [
          new discord.MessageEmbed()
            .setDescription(
              `${language.urlCreated}\n\n**URL Corta:** [https://roxxy.es/url/${kaka}](https://roxxy.es/url/${kaka})\n**URL Completa:** ${args[0]}\n\n**Tenga en cuenta que al crear direcciones URL, cumple con nuestra [política](https://roxxy.es/url)**`
            )
