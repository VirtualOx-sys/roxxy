...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      name: "report",
      description: "Habilite los informes del servidor!",
      category: "Utilidad",
      usage: ["<enable #canal | disable> / report @usuario / ID <razón>"],
      examples: [
        "report enable #reportes",
        "report disable",
    ...
    if (args.includes("disable") || args.includes("off")) {
      ...
      if (guildDB.report.disableIssue == "true") {
        const embed = new MessageEmbed()
          .setColor(message.guild.me.displayHexColor)
          .setDescription(
            `Los informes de problemas están deshabilitados en el servidor actual ${message.client.emoji.fail}`
          );
      ...
      let reportEmbed1 = new MessageEmbed()
        .setAuthor(`${language.report16} (Cuestión)`)
        ...
        message.channel.sendCustom({
          embeds: [
            new MessageEmbed()
              .setColor(message.guild.me.displayHexColor)
              .setDescription(
                `Los informes de usuario están deshabilitados en el servidor actual ${message.client.emoji.fail}`
              ),
          ],
        });
        return;
      ...
      let reportEmbed1 = new MessageEmbed()
        .setAuthor(`${language.report16} (Usuario)`)
        .setDescription(`**${language.report17}**`)
        .addField(`${language.report18}`, `${message.member}`, true)
        .addField(`${language.report19}`, `${message.member.id}`, true)
        .addField(`${language.report20}`, `${message.author.tag}`, true)
