...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      name: "tempvc",
      description: "Habilitar / Deshabilitar tempvc",
      category: "Utilidad",
    ...
    if (args.includes("disable") || args.includes("off")) {
      ...
      try {
        ...
        let category = message.guild.channels.cache.find(
          (c) =>
            c.name.toLowerCase() == "únete para crear" &&
        ...
        setTimeout(async () => {
          if (!category) {
            await embed
              ...
              .setFooter({ text: `Roxxy` })
              .setTimestamp();
            msg.edit({ embeds: [embed] }) +
              message.guild.channels.create(`Únete Para Crear`, {
                type: "GUILD_CATEGORY",
        ...
        let voice = message.guild.channels.cache.find(
          (c) =>
            c.name.toLowerCase() == "únete para crear" && c.type == "GUILD_VOICE"
        );
        ...
        setTimeout(async () => {
          if (!voice || !category) {
            embed
              .setAuthor(`Error De Configuración`)
              .setDescription(
