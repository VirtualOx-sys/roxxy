...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      description: "¡Cierra un ticket abierto!",
      category: "Tickets",
      cooldown: 3,
  ...
  async run(message, args) {
        ...
        .sendCustom({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(
                `No se puede cerrar el ticket, parece que no está en ningún canal de tickets.`
              )
    ...
    await reactionTicket.findOne(
      ...
      async (err, db) => {
              ...
              return message.channel.sendCustom({
                embeds: [
                  new discord.MessageEmbed()
                    ...
                    .setDescription(
                      `${message.client.emoji.fail} Solo los usuarios con el rol de equipo de soporte pueden cerrar este ticket`
                    )
                    .setFooter({ text: "https://roxxy.es" })
                    .setTimestamp()
                    .setColor("RED"),
          ...
          if (messages) {
            for (const message of messages
              ...
              if (message && message.content && message.author.id) {
                ...
                paste.paste.push(`(embed enviado)`);
                paste.paste2.push(message.author.id);
              }
            }
          }
            ...
            let closeEmbed = new MessageEmbed()
              ...
              .addField(
                ...
                `**Usuario:** ${message.author}\n**Canal Del Ticket:** #${
                  ...
                  "dddd, MMMM Do YYYY"
                )}\n**Transcripción:** [aquí](https://roxxy.es/paste/${ticketID})`
              );
        ...
        message.channel.send("cerrando ticket...");
        setTimeout(() => {
