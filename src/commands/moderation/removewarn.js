...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      description: "Elimina una advertencia de cierto usuario",
      category: "Moderacion",
      usage: "<usuario> [ID]",
      examples: ["rw @VirtualOx iasdjas"],
      guildOnly: true,
  ...
  async run(message, args) {
    ...
    const removeEmbed = new discord.MessageEmbed()
      .setDescription(
        ...
        } | Advertencia borrada **#${warningID}** de **${
            ...
            if (
              ...
              if (logging.moderation.warns == "true") {
                ...
                const logEmbed = new MessageEmbed()
                  .setAuthor(
                    `Acción: \`Eliminar Advertencia\` | ${mentionedMember.user.tag} | Caso #${logcase}`,
                  ...
                  .setFooter({
                    text: `ID: ${mentionedMember.id} | ID De Advertencia: ${warningID}`,
                  })
                  .setTimestamp()
                  .setColor(color);
