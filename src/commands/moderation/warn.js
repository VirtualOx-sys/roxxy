...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      aliases: ["w"],
      description:
        "Da una advertencia al usuario especificado en su servidor Discord.",
      category: "Moderacion",
      usage: "<usuario> [razón]",
      examples: ["warn @VirtualOx Por favor, no jures."],
      guildOnly: true,
  ...
  async run(message, args) {
    ...
    if (
      ...
      if (logging.moderation.warn_action === "2") {
        dmEmbed = `${message.client.emoji.fail} Has sido advertido en **${message.guild.name}**`;
