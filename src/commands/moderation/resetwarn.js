...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      ...
      description: "Borrar todas las advertencias del usuario",
      category: "Moderacion",
      usage: "<usuario> [razón]",
      examples: ["resetwarn @VirtualOx"],
      guildOnly: true,
  ...
  async run(message, args) {
    ...
    const removeEmbed = new discord.MessageEmbed()
      .setDescription(
        `${message.client.emoji.success} | Limpiando todas las advertencias de **${
            ...
            if (
              ...
              if (logging.moderation.warns == "true") {
                ...
                const logEmbed = new MessageEmbed()
                  .setAuthor(
                    `Acción: \`Borrar Advertencia\` | ${mentionedMember.user.tag} | Caso #${logcase}`,
