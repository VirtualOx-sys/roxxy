...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      name: "lock",
      aliases: ["lc"],
      description: "Bloquea el canal actual / mencionado.",
      category: "Moderacion",
      usage: "<canal> [tiempo]",
  ...
  async run(message, args) {
    ...
    if (channel) {
      reason = args.join(" ").slice(22) || "`ninguna`";
    ...
    if (
      ...
      const lockchannelError2 = new MessageEmbed()
        .setDescription(`${fail} | ${channel} ya está bloqueado`)
    ...
    const embed = new MessageEmbed()
      .setDescription(
        `${success} | Bloqueado con éxito **${channel}** ${
            ...
            if (
              ...
              if (logging.moderation.lock == "true") {
                ...
                const logEmbed = new MessageEmbed()
                  .setAuthor(
                    `Acción: \`Bloquear\` | ${message.author.tag} | Caso #${logcase}`,
