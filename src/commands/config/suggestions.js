...
module.exports = class extends Command {
  constructor(...args) {
    super(...args, {
      name: "suggestion",
      description: "Habilitar o deshabilitar y aprobar o rechazar sugerencias",
      category: "Config",
      usage: [
        "<enable #canal | disable> / suggestion approve/decline <ID mensaje>",
      ],
      examples: [
        "suggestion enable #sugerencias",
        "suggestion disable",
        ...
        return message.channel.sendCustom({
          embeds: [
            new MessageEmbed()
              ...
              .setDescription(
                `${fail} El personal no puede aprobar ni rechazar sugerencias en este servidor.`
              )
              .setFooter({ text: "https://roxxy.es/" })
              .setTimestamp()
              .setColor("RED"),
